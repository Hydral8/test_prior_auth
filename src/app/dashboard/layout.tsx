...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const [session, setSession] = useState<{ memberName: string; memberId: string; email: string } | null>(null);
    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col">
        ...
        <div className="p-4 border-t border-slate-200">
          <div className="mb-3">
            <p className="text-sm font-medium text-slate-900">{session.memberName}</p>
            <p className="text-xs text-slate-400">{session.memberId}</p>
          </div>
          <button
